    ...
    )
{
    const static COLUMN_INFO columns[] =
    {
        ...
        { ETPRTNC_DISKREADSDELTA, L"磁盘读取变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_DISKWRITESDELTA, L"磁盘写入变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_DISKREADBYTESDELTA, L"磁盘读取字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_DISKWRITEBYTESDELTA, L"磁盘写入字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_DISKTOTALBYTESDELTA, L"磁盘总字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        ...
        { ETPRTNC_NETWORKRECEIVESDELTA, L"网络接收变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NETWORKSENDSDELTA, L"网络发送变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NETWORKRECEIVEBYTESDELTA, L"网络接收字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NETWORKSENDBYTESDELTA, L"网络发送字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NETWORKTOTALBYTESDELTA, L"网络总字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_HARDFAULTS, L"硬性缺页次数", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_HARDFAULTSDELTA, L"硬性缺页变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_PEAKTHREADS, L"线程峰值", 45, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_GPU, L"GPU", 45, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_GPUDEDICATEDBYTES, L"GPU 独占显存", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_GPUSHAREDBYTES, L"GPU 共享显存", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        ...
        { ETPRTNC_FPS, L"帧率（FPS）", 50, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NPU, L"NPU", 45, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NPUDEDICATEDBYTES, L"NPU 独占内存", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETPRTNC_NPUSHAREDBYTES, L"NPU 共享内存", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
    };
    ...
    )
{
    const static COLUMN_INFO columns[] =
    {
        ...
        { ETNETNC_RECEIVESDELTA, L"接收变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETNETNC_SENDSDELTA, L"发送变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETNETNC_RECEIVEBYTESDELTA, L"接收字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETNETNC_SENDBYTESDELTA, L"发送字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
        { ETNETNC_TOTALBYTESDELTA, L"总字节变化量", 70, PH_ALIGN_RIGHT, DT_RIGHT, TRUE },
            ...
            case ETNETNC_FIREWALLSTATUS:
                {
                    ...
                    if (block->FirewallStatus >= FirewallUnknownStatus && block->FirewallStatus < FirewallMaximumStatus)
                    {
                        static CONST PH_STRINGREF strings[FirewallMaximumStatus] =
                        {
                            ...
                            PH_STRINGREF_INIT(L"允许，未受限制"),
                            PH_STRINGREF_INIT(L"允许，受限"),
                            PH_STRINGREF_INIT(L"不允许，未受限制"),
                            PH_STRINGREF_INIT(L"不允许，受限"),
                        };
