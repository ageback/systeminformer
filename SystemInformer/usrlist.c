    ...
    )
{
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_PASSWORD_LAST_SET, TRUE, L"上次设置密码", 140, PH_ALIGN_LEFT, index++, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_FAILED_ATTEMPTS_SINCE_LAST_SUCCESSFUL_LOGON, FALSE, L"自上次成功登录后的失败次数", 80, PH_ALIGN_LEFT, index++, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LAST_SUCCESSFUL_LOGON, FALSE, L"最后一次成功登录", 140, PH_ALIGN_LEFT, index++, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LAST_FAILED_LOGON, FALSE, L"最后一次失败登录", 140, PH_ALIGN_LEFT, index++, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_LOGOFF_TIME, FALSE, L"注销时间", 140, PH_ALIGN_LEFT, index++, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_KICKOFF_TIME, FALSE, L"强制下线时间", 140, PH_ALIGN_LEFT, index++, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_PASSWORD_CAN_CHANGE, FALSE, L"可更改密码", 140, PH_ALIGN_LEFT, index++, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, PH_USER_LIST_COLUMN_PASSWORD_MUST_CHANGE, FALSE, L"必须更改密码", 140, PH_ALIGN_LEFT, index++, 0);
